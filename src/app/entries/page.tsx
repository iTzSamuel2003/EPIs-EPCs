...
type EntryItem = { material_id: string; lot_number: string; quantity: string; manufactured_at: string; expires_at: string };
const newItem = (): EntryItem => ({ material_id: "", lot_number: "", quantity: "1", manufactured_at: "", expires_at: "" });
