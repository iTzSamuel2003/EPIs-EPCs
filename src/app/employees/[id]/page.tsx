...
import { AlertTriangle, ArrowLeft, CalendarClock, Check, Download, LoaderCircle, PackageCheck, Printer, ShieldCheck, Upload, UserRound, X } from "lucide-react";
...
export default function EmployeeMaterialsPage() {
  ...
  const deliverySheets = useMemo(() => {
    const grouped = new Map<string, { id: string; delivered_at: string; reason: string; term_file_path: string | null; term_uploaded_at: string | null; items: number; materials: Item[] }>();
    items.forEach((item) => {
